package com.demo.shiro_demo.common.consts;
...
public class SystemPerms {
    ...
    public class LoginLog {
        ...
        public static final String CLEAN = "system:loginLog:clean";
    }
    ...
    public class SystemLog {
        ...
        public static final String CLEAN = "system:systemLog:clean";
    }
    ...
    public class DictDate {
        public static final String VIEW = "system:dictDate:view";
        public static final String LIST = "system:dictDate:list";
        public static final String SAVE = "system:dictDate:save";
        public static final String UPDATE = "system:dictDate:update";
        public static final String DELETE = "system:dictDate:delete";
    }
}
