...
import com.demo.shiro_demo.util.StrawStringUtils;
...
public class CodeGenerator {
    ...
    private static final String javaLocation = projectPath + "/src/main/java/com/demo/shiro_demo/";
    ...
    private static final String author = "Jerry";
    private static final String basePackage = "com.demo.shiro_demo";
    private static final String moduleName = "";
    private static final String tablePrefix = "sys_";

    public static void main(String[] args) {
        String[] nameList = new String[]{"sys_map_role_resource", "sys_map_user_role", "sys_resource_info", "sys_role_info", "sys_system_config", "sys_system_log", "sys_user_info"};
    ...
    public static void codeGenerator(String tableName) {
        ...
        // 实体类父类
        strategy.setSuperEntityClass("com.demo.shiro_demo.common.dto.BaseEntity");
