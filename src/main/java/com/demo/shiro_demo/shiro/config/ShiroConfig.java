package com.demo.shiro_demo.shiro.config;

import at.pollux.thymeleaf.shiro.dialect.ShiroDialect;
import com.demo.shiro_demo.shiro.filter.AjaxFilter;
import com.demo.shiro_demo.shiro.filter.SystemConfigAccessControllerFilter;
import com.demo.shiro_demo.shiro.realm.ShiroRealm;
...
/**
 * @Author Jerry
 * @Description shiro 权限配置
 * @Create 26/12/2022 2:15 PM
 * 参考文章：
...
public class ShiroConfig {
    ...
    public SimpleCookie rememberMeCookie() {
        // cookie名称，对应前端 checkbox 的 name = remenberMe
